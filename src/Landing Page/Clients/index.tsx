    ...
    <>
      <Box style={{ margin: "100px 0" }}>
        ...
        <Box style={{
          ...
          <Typography color={"#C8C8C8"} style={{ fontSize: "30px", fontWeight: '500', textAlign: 'center', padding: '0 15px' }} variant="body2">
        ...
        <Grid sx={{ padding: '10px 100px', marginY: '25px' }} container spacing={4}>
